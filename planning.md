# ACE-Blizt — P2P Energy Trading on Monad
...
> "PLN monopoli harga listrik dan datanya tidak transparan — ACE-Blizt kasih warga kemampuan jual-beli energi langsung, on-chain, fair."
...
`[0:00]` Layar besar tampil marketplace — ada 2-3 seller dengan harga listrik berbeda. "Ini ACE-Blizt — marketplace jual beli listrik antar warga, langsung, tanpa PLN."
...
`[1:50]` "ACE-Blizt. Energi rakyat, untuk rakyat." — selesai.
